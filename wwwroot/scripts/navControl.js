...
(function (navControl, $, undefined) {
    ...
    navControl.debugState = function () {
        for (var p in this) {
            if (typeof this[p] != "function") console.log("Value of " + p + " is " + this[p].toString());
        }
        console.log("isModalOpen: " + isModalOpen);
        console.log("_openPanelName: " + _openPanelName);
        console.log("_bookmarkName: " + _bookmarkName);
    }
    ...
    var _templatePopup = '<div class="w3-container w3-modal w3-animate-zoom w3-padding-16" id="[[popupPanelID]]" ><div class="w3-modal-content "><div class="w3-content"><header class="[[popupPanelHeaderCSS]] w3-container"><div class="w3-right"><a href="javascript:void(0)" onclick="navControl.modal(\'[[popupPanelID]]\',true)"><i class="fa fa-window-close" aria-hidden="true"></i></a></div><span data-bind="text:$root.currentItem().Name">[[popupPanelName]]</span></header><div class="w3-panel"><div class="w3-content" id="[[popupPanelID]]_content">Loading Content to Display ...</div></div><header class="[[popupPanelHeaderCSS]] w3-container"><div class="w3-right"><a href="javascript:void(0)" onclick="navControl.modal(\'[[popupPanelID]]\',true)"><i class="fa fa-window-close" aria-hidden="true"></i></a></div><span data-bind="text:$root.currentItem().Name">[[popupPanelName]]</span></header></div></div></div>';
    ...
    */
    ...
    //Generate a new DOM element from 
    navControl.dynamicPopup = function () {
